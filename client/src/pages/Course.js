...
function Course({ authState, username }) {
  ...
  useEffect(() => {
    axios
      .get(
        `${process.env.REACT_APP_URL}/course/${universityTag}/${facultyName}/${courseID}`
      )
      .then((response) => {
    ...
    axios
      .get(
        `${process.env.REACT_APP_URL}/review/${universityTag}/${facultyName}/${courseID}`
      )
      .then((response) => {
    ...
    axios
      .get(
        `${process.env.REACT_APP_URL}/course/${universityTag}/${facultyName}/${courseID}/professors`
      )
      .then((response) => {
