...
function NewReview(props) {
  ...
  console.log(data);
  try {
    axios.post(`http://localhost:3001/review/post/${universityTag}/${facultyName}/${courseID}`, data,
    {
      headers: {
  ...
  return (
    <div className="course">
      {console.log(props.listOfProfessors)};
      {console.log("BLALALADS")}
      {console.log(list.listOfProfessors)}
      <form>
        ...
        <p className="caption"><small>Can't find your professor? Add it</small></p>
                  ...
                  <Grid item xs={8} md={8} lg={15}>
                    ...
                    <TextField
                      ...
                      required
                    />
                    <Button variant="contained" type="button" disabled={!enabled} sx={{m: 1}} onClick={onSubmit}>Submit</Button>
